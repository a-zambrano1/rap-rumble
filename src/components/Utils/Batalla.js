            ...
            <div className='flex flex-col gap-5 my-auto items-center border-2 rounded-3xl relative'>
                <div className='flex w-full '>
                    <div className='items-center w-72'>
                        {imageUrls ? <img className="w-full rounded-3xl" src={imageUrls[0]} alt={mc1} style={{ objectFit: 'cover' }} /> : <p>Cargando imagen...</p>}
                    ...
                    <div className='items-center w-72'>
                        {imageUrls ? <img className="w-full rounded-3xl" src={imageUrls[1]} alt={mc2} style={{ objectFit: 'cover' }} /> : <p>Cargando imagen...</p>}
